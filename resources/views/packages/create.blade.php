...
@section('breadceumbs')
    {{-- <x-bread-crumps> --}}
    @component('components.bread-crumps', ['head' => 'Add New Packages', 'links' => ['Dashboard', 'Packages', 'Add New
        Packages']])
    @endcomponent
@endsection
            ...
            <div class="col-lg-12 mb-lg-0 mb-4">
                <div class="card z-index-2 h-100">
                    <div class="card-header pb-0 pt-3 bg-transparent">
                        <div class="row">
                            <h6 class="text-capitalize col-4"> {{ __('translation.add_new_package') }}</h6>
                            <div class="col-6"></div>
                            <div class="col-2">
