...
@section('breadceumbs')
    ...
    [
        'head' => __('translation.create_a_new_Scrren_Three'),
        'links' => [BredCrumpLinks(route('application.index'), __('translation.Home')), BredCrumpLinks(route('application.index'), __('translation.add_Scrren_Three'))],
    ])
    @endcomponent
@endsection
                            ...
                            <div class="col no-gutters">
                                <div class="form-group col-md-6" style="display: contents;">
                                    <form action="{{ route('Screen.store2') }}" method="post" enctype="multipart/form-data"
                                        class="form">
                                        @csrf
                                        <h1 class="text-center">{{__('translation.My_Screen_Three')}}</h1>
                                        <!-- Progress bar -->
