    ...
    <section class="foi-page-section">
        <div class="row mb-5">
            <div class="col-md-4 foi-feature">
                <img src="{{ asset('landing-assets/images/icon_1.png') }}" alt="icon" class="feature-icon">
                <h5 class="feature-title">Online Payment</h5>
                <p class="feature-content">Lorem ipsum dolor sit amt, consectet adop adipisicing elit, sed do
                    eiusmod teporara incididunt ugt labore.</p>
                <a href="#!" class="feature-link">Find out More</a>
            </div>
            <div class="col-md-4 foi-feature">
                <img src="{{ asset('landing-assets/images/icon_2.png') }}" alt="icon" class="feature-icon">
                <h5 class="feature-title">Online Payment</h5>
                <p class="feature-content">Lorem ipsum dolor sit amt, consectet adop adipisicing elit, sed do
                    eiusmod teporara incididunt ugt labore.</p>
                <a href="#!" class="feature-link">Find out More</a>
            ...
            <div class="col-md-4 foi-feature">
                <img src="{{ asset('landing-assets/images/icon_3.png') }}" alt="icon" class="feature-icon">
                <h5 class="feature-title">Online Payment</h5>
                <p class="feature-content">Lorem ipsum dolor sit amt, consectet adop adipisicing elit, sed do
                    eiusmod teporara incididunt ugt labore.</p>
                <a href="#!" class="feature-link">Find out More</a>
    ...
    <section class="foi-page-section">
        <div class="row">
            <div class="col-md-6 mb-5 mb-md-0">
                <img src="{{ asset('landing-assets/images/img_3.png') }}" alt="faq" class="img-fluid" width="424px">
            </div>
            <div class="col-md-6">
                ...
                <div class="card feature-faq-card">
                    <div class="card-header bg-white" id="featureFaqOneTitle">
                        <a href="#featureFaqOneCollapse" class="d-flex align-items-center" data-toggle="collapse">
                            <h5 class="mb-0">How can I get a refund?</h5> <i
                ...
                <div class="card feature-faq-card">
                    <div class="card-header bg-white" id="featureFaqTwoTitle">
                        <a href="#featureFaqTwoCollapse" class="d-flex align-items-center" data-toggle="collapse">
                            <h5 class="mb-0">Which license should I need?</h5> <i
                                class="far fa-plus-square ml-auto"></i>
                        </a>
                    </div>
                ...
                <div class="card feature-faq-card">
                    <div class="card-header bg-white" id="featureFaqThreeTitle">
                        <a href="#featureFaqThreeCollapse" class="d-flex align-items-center" data-toggle="collapse">
                            <h5 class="mb-0">How do I get a receipt for my purchase?</h5> <i
                                class="far fa-plus-square ml-auto"></i>
                        </a>
                    </div>
                ...
                <div class="card feature-faq-card">
                    <div class="card-header bg-white" id="featureFaqFourTitle">
                        <a href="#featureFaqFourCollapse" class="d-flex align-items-center" data-toggle="collapse">
                            <h5 class="mb-0">How do I report an issue?</h5> <i
                                class="far fa-plus-square ml-auto"></i>
                        </a>
                    </div>
