<div class="container">
    <div class="row footer-content">
        ...
        <div class="col-md-4 col-lg-5 col-xl-6 py-3 py-md-0 d-md-flex align-items-center justify-content-end">
            <a href="contact" class="btn btn-danger btn-lg">Contact form</a>
        </div>
    </div>
    <div class="row footer-widget-area">
        <div class="col-md-3">
            <div class="py-3">
                <img src="{{ asset('landing-assets/images/logo-white.svg') }}" alt="FOI">
            </div>
        ...
        <div class="col-md-3 mt-3 mt-md-0">
            ...
            <nav class="social-menu">
                <a href="#!"><img src="{{ asset('landing-assets/images/facebook.svg') }}" alt="facebook"></a>
                <a href="#!"><img src="{{ asset('landing-assets/images/instagram.svg') }}" alt="instagram"></a>
                <a href="#!"><img src="{{ asset('landing-assets/images/twitter.svg') }}" alt="twitter"></a>
                <a href="#!"><img src="{{ asset('landing-assets/images/youtube.svg') }}" alt="youtube"></a>
            </nav>
        </div>
    </div>
</div>
