<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
        ...
        <div class="sidebar-brand-text mx-3">App Genartor <sup>2</sup></div>
    </a>
    ...
    <div class="sidebar-heading">
        Fetures Package Subscribtion
    </div>
    <!-- Nav Item - Pages Collapse Menu -->
    <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseTwo"
            aria-expanded="true" aria-controls="collapseTwo">
            {{-- <i class="fa  fa-transformer-bolt"></i> --}}
            <i class="fa fa-thin fa-money-bill"></i>
            <span>Package</span>
        </a>
    ...
    <li class="nav-item">
        ...
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
            ...
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="{{route('client.reports')}}">Clients Reports</a>
                <a class="collapse-item" href="{{route('subscription.reports')}}">Subscribtion Report</a>
    ...
    <li class="nav-item">
        ...
        <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="{{route('client.index')}}">CLients Profiles</a>
        </div>
    </li>
    <li class="nav-item">
