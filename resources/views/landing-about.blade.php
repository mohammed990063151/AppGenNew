        ...
        <div class="row">
            <div class="col-md-6 mb-4 mb-md-0 pr-lg-0">
                <h2 class="about-section-one-title">
                    With more apps than iOS, Android puts <span class="font-weight-normal">a world of options at
            ...
            <div class="col-md-6 pl-lg-0 d-flex align-items-center align-items-lg-end">
                <img src="{{ asset('landing-assets/images/about_img_1.png') }}" alt="about" class="img-fluid"
                    width="448px">
            </div>
        </div>
    </section>
    <section class="foi-page-section">
        <div class="row">
            <div class="col-md-6 mb-5 mb-md-0">
                <img src="{{ asset('landing-assets/images/about_img_2.png') }}" alt="about 2"
                    class="w-100 img-fluid pr-md-5" width="437px">
            </div>
            <div class="col-md-6">
                <h2 class="about-section-two-title">We create the best <span class="font-weight-normal">solution
                        for you and your business.</span></h2>
        ...
        <div class="row">
            <div class="col-md-3 mb-5">
                <div class="team-member-card">
                    <img src="{{ asset('landing-assets/images/user/user_1.png') }}" alt="Cardarion Hart"
            ...
            <div class="col-md-3 mb-5">
                <div class="team-member-card">
                    <img src="{{ asset('landing-assets/images/user/user_2.png') }}" alt="Gauthier Drewitt"
                        class="team-member-avatar">
            ...
            <div class="col-md-3 mb-5">
                <div class="team-member-card">
                    <img src="{{ asset('landing-assets/images/user/user_3.png') }}" alt="Labeeba Al Amer"
                        class="team-member-avatar">
            ...
            <div class="col-md-3 mb-5">
                <div class="team-member-card">
                    <img src="{{ asset('landing-assets/images/user/user_4.png') }}" alt="Onyama Limba"
                        class="team-member-avatar">
            ...
            <div class="col-md-3 mb-5">
                <div class="team-member-card">
                    <img src="{{ asset('landing-assets/images/user/user_5.png') }}" alt="Athar Malakooti"
                        class="team-member-avatar">
            ...
            <div class="col-md-3 mb-5">
                <div class="team-member-card">
                    <img src="{{ asset('landing-assets/images/user/user_6.png') }}" alt="Kung Jiyeon"
                        class="team-member-avatar">
            ...
            <div class="col-md-3 mb-5">
                <div class="team-member-card">
                    <img src="{{ asset('landing-assets/images/user/user_7.png') }}" alt="Mathijn Agter"
                        class="team-member-avatar">
            ...
            <div class="col-md-3 mb-5">
                <div class="team-member-card">
                    <img src="{{ asset('landing-assets/images/user/user_8.png') }}" alt="Jontray Arnold"
                        class="team-member-avatar">
