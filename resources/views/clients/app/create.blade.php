...
@section('breadceumbs')
    {{-- <x-bread-crumps> --}}
    @component('components.bread-crumps', ['head' => __('translation.App_profile'), 'links' => [__('translation.Dashboard'),
        __('translation.Add_Newapplction')]])
    @endcomponent
@endsection
@section('title')
    Add applction
                        ...
                        <div class="row">
                                        ...
                                        <div class="content">
                                            ...
                                            <div class="project-card text-center">
                                                ...
                                                <div class="project-info">
                                                    <p class="project-category"> {{ __('translation.app_photo') }}</p>
                            ...
                            <div class="col-md-9">
                                <form action="{{ route('application.store') }}" method="post"
                                    ...
                                    @csrf
                                    <h5>{{ __('translation.Applction_details') }}</h5>
                                    <div class="row col-md-12">
                                        ...
                                        @error('Logo')
                                            <span class="text-danger error"> class="text-danger error">$message }}</span>
                                        @enderror
                                    ...
                                    <div class="row col-md-12">
                                        ...
                                        <div class="col-md-6">
                                            <label for="">{{ __('translation.WhatsApp') }}</label>
                                    ...
                                    {{-- <div class="row col-md-12"> --}}
                                    <div class="col-md-12">
                                        <label> {{ __('translation.Discrptions') }}</label>
                                        <textarea name="Discrptions" id="" cols="30" rows="10" class="form-control"></textarea>
                                        @error('Discrptions')
                                            <span class="text-danger error"> class="text-danger error">$message }}</span>
                                        @enderror
                                    </div><br><br>
