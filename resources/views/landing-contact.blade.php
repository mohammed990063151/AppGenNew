...
@section('containt')
    ...
    <section class="contact-content">
        <div class="contact-widget media">
            <img src="{{ asset('landing-assets/images/icon-4.png') }}" alt="monitor" width="50px">
        ...
        <div class="contact-widget media">
            <img src="{{ asset('landing-assets/images/icon-5.png') }}" alt="book" width="40px">
            <div class="media-body">
    ...
    <section class="contact-form-wrapper">
        <form action="index">
            ...
            <div class="text-center">
                ...
                <p class="form-footer-text">We will get back to you in 1-2 business days.</p>
            </div>
        </form>
    </section>
    </div>
