            ...
            <div class="card z-index-2 h-100">
                <div class="card-header pb-0 pt-3 bg-transparent">
                    <div class="d-flex justify-content-between">
                        <h6 class="text-capitalize col-4">Admins Mangement</h6>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="admin_name" id=""
                                            aria-describedby="helpId" value="{{$Admin->name ?? null}}" placeholder="">
                                        @error('admin_name')
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="{{ $Admin->email ?? null }}" name="admin_email" id="" class="form-control" placeholder=""
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text"  name="admin_password_confirm" id="" class="form-control" placeholder=""
                                            aria-describedby="helpId">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="">admin password</label>
                                        <input type="text" name="admin_password" id="" class="form-control" placeholder=""
                                            aria-describedby="helpId">
