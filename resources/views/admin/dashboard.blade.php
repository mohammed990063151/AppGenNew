...
@section('content')
    <section class="row">
        <div class="col-12 col-lg-9">
                    ...
                    <div class="card">
                        <div class="card-body px-3 py-4-5">
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    <h6 class="text-muted font-semibold">{{ __('translation.Profile_Views') }}</h6>
                    ...
                    <div class="card">
                        <div class="card-body px-3 py-4-5">
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    <h6 class="text-muted font-semibold">{{ __('translation.Saved_Post') }}</h6>
            ...
            <div class="row">
                <div class="col-12 col-xl-4">
                    <div class="card">
                        <div class="card-header">
                            <h4>{{ __('translation.Profile_Visit_country') }}</h4>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-6">
                ...
                <div class="col-12 col-xl-8">
                    <div class="card">
                        <div class="card-header">
                            <h4>{{ __('translation.Latest_Comments') }}</h4>
                        </div>
                        <div class="card-body">
        ...
        <div class="col-12 col-lg-3">
            ...
            <div class="card">
                <div class="card-header">
                    <h4>{{ __('translation.Recent_Messages') }}</h4>
                </div>
