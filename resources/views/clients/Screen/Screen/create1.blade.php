...
@section('breadceumbs')
    {{-- <x-bread-crumps> --}}
    @component('components.bread-crumps', ['head' => 'Add screen tow', 'links' => ['screen', 'Add screen tow']])
    @endcomponent
@endsection
@section('title')
    Add screen tow
            ...
            <div class="col-lg-12 mb-lg-0 mb-4">
                <div class="card z-index-2 h-100">
                    <div class="card-header pb-0 pt-3 bg-transparent">
                        ...
                        <h6 class="text-capitalize col-4">add screen tow</h6>
                        <div class="row">
                            <div class="col-6"></div>
                            <div class="col-2">
                        ...
                        <div class="col-md-12">
                            <div class="mt-3">
                                ...
                                <form action="{{ route('Screen.store1') }}" method="post" enctype="multipart/form-data">
                                    @csrf
